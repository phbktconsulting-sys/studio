      ...
      <div className="flex-1 overflow-y-auto px-4 pt-0 sm:px-6">
        ...
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="flex h-auto rounded-none bg-transparent p-0">
            <TabsTrigger value="overview" className="relative flex-1 justify-center h-7 rounded-none border-b-2 border-transparent bg-[#A91D22] px-1 text-xs text-white transition-none hover:bg-[#A91D22]/80 data-[state=active]:border-transparent data-[state=active]:bg-[#A91D22]/90 data-[state=active]:text-white data-[state=active]:shadow-inner">Work Overview</TabsTrigger>
            <TabsTrigger value="notes" className="relative flex-1 justify-center h-7 rounded-none border-b-2 border-transparent bg-[#A91D22] px-1 text-xs text-white transition-none hover:bg-[#A91D22]/80 data-[state=active]:border-transparent data-[state=active]:bg-[#A91D22]/90 data-[state=active]:text-white data-[state=active]:shadow-inner">Notes</TabsTrigger>
            <TabsTrigger value="contact" className="relative flex-1 justify-center h-7 rounded-none border-b-2 border-transparent bg-[#A91D22] px-1 text-xs text-white transition-none hover:bg-[#A91D22]/80 data-[state=active]:border-transparent data-[state=active]:bg-[#A91D22]/90 data-[state=active]:text-white data-[state=active]:shadow-inner">Contact Info</TabsTrigger>
            <TabsTrigger value="images" className="relative flex-1 justify-center h-7 rounded-none border-b-2 border-transparent bg-[#A91D22] px-1 text-xs text-white transition-none hover:bg-[#A91D22]/80 data-[state=active]:border-transparent data-[state=active]:bg-[#A91D22]/90 data-[state=active]:text-white data-[state=active]:shadow-inner">Images</TabsTrigger>
            <TabsTrigger value="associations" className="relative flex-1 justify-center h-7 rounded-none border-b-2 border-transparent bg-[#A91D22] px-1 text-xs text-white transition-none hover:bg-[#A91D22]/80 data-[state=active]:border-transparent data-[state=active]:bg-[#A91D22]/90 data-[state=active]:text-white data-[state=active]:shadow-inner">Associations</TabsTrigger>
            <TabsTrigger value="tasks" className="relative flex-1 justify-center h-7 rounded-none border-b-2 border-transparent bg-[#A91D22] px-1 text-xs text-white transition-none hover:bg-[#A91D22]/80 data-[state=active]:border-transparent data-[state=active]:bg-[#A91D22]/90 data-[state=active]:text-white data-[state=active]:shadow-inner">Tasks</TabsTrigger>
            <TabsTrigger value="quotation" className="relative flex-1 justify-center h-7 rounded-none border-b-2 border-transparent bg-[#A91D22] px-1 text-xs text-white transition-none hover:bg-[#A91D22]/80 data-[state=active]:border-transparent data-[state=active]:bg-[#A91D22]/90 data-[state=active]:text-white data-[state=active]:shadow-inner">Quotation</TabsTrigger>
            <TabsTrigger value="agency" className="relative flex-1 justify-center h-7 rounded-none border-b-2 border-transparent bg-[#A91D22] px-1 text-xs text-white transition-none hover:bg-[#A91D22]/80 data-[state=active]:border-transparent data-[state=active]:bg-[#A91D22]/90 data-[state=active]:text-white data-[state=active]:shadow-inner">Agency</TabsTrigger>
          </TabsList>
