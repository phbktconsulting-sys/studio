...
import {
  DeleteWorkItemInputSchema,
  DeleteWorkItemOutputSchema,
  type DeleteWorkItemInput,
  type DeleteWorkItemOutput,
} from '@/lib/types';
...
export async function deleteWorkItem(payload: DeleteWorkItemInput): Promise<DeleteWorkItemOutput> {
  return deleteWorkItemFlow(payload);
}

const deleteWorkItemFlow = ai.defineFlow(
  {
    name: 'deleteWorkItemFlow',
    inputSchema: DeleteWorkItemInputSchema,
